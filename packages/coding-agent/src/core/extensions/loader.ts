...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@summon/agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@summon/tui");
	const piAiEntry = resolveWorkspaceOrImport("ai/dist/index.js", "@summon/ai");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@summon/ai/oauth");

	_aliases = {
		"@summon/coding-agent": piCodingAgentEntry,
		"@summon/agent-core": piAgentCoreEntry,
		"@summon/tui": piTuiEntry,
		"@summon/ai": piAiEntry,
		"@summon/ai/oauth": piAiOauthEntry,
